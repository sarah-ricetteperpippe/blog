...
1. Heat the oil over **medium-low** heat — it should not smoke.
2. Add all the vegetables at once.
3. Stir every two minutes. Don't stare at them, but don't forget them either.
4. They should **soften and become translucent**, not brown (unless the recipe calls for it).
5. This takes about **10-15 minutes**. If it sizzles too loudly, lower the heat.
